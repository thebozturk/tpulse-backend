...
export class LeaguesController {
  ...
  findAll(
    ...
    return this.leagues.findAll(query.page, query.pageSize, lang);
  }
  ...
  async findByCode(
    ...
    return { data: await this.leagues.findByCode(code, lang) };
  }
  ...
  async findOne(
    ...
    return { data: await this.leagues.findById(id, lang) };
  }
}
